...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \Iphp\FileStoreBundle\EventListener\UploaderListener($this->get('iphp.filestore.datastorage'), $this->get('iphp.filestore.filestorage.file_system'), $this->get('iphp.filestore.mapping.factory')));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test', 'user' => 'dzordz', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\SklepBundle\\Entity'))), 'SklepBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('SklepBundle' => 'SklepBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_72101ff1dd72c767c00f7a83e6cb627d5f72ccdc7a7f530ee0f9762b5b11c0af');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('SklepBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('SklepBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('SklepBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('SklepBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'SklepBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/.*?add');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'IphpFileStoreBundle:Form:fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SklepBundle/Resources/views'), 'Sklep');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d66c713f1c361696028c76c75c2fc87888fe18ce');
    }
    ...
    {
        return $this->services['iphp.filestore.mapping.factory'] = new \Iphp\FileStoreBundle\Mapping\PropertyMappingFactory(new \Iphp\FileStoreBundle\Naming\NamerServiceInvoker($this), new \Iphp\FileStoreBundle\Driver\AnnotationDriver($this->get('annotation_reader')), array('photo' => array('upload_dir' => ($this->targetDirs[2].'/../web/photo'), 'upload_path' => '/photo', 'delete_on_remove' => true, 'overwrite_duplicates' => false, 'namer' => array(), 'directory_namer' => array())));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SklepBundle' => 'SklepBundle\\SklepBundle',
            ...
            'locale' => 'en',
            'secret' => 'd66c713f1c361696028c76c75c2fc87888fe18ce',
            ...
            'kernel.secret' => 'd66c713f1c361696028c76c75c2fc87888fe18ce',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'IphpFileStoreBundle:Form:fields.html.twig',
            ),
            ...
            'assetic.ruby.bin' => 'D:\\Programowanie\\bin\\ruby.EXE',
            ...
            'fos_user.model.user.class' => 'SklepBundle\\Entity\\User',
