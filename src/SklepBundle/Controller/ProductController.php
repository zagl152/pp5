...
use SklepBundle\Entity\Product;
use SklepBundle\Form\ProductType;
...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SklepBundle:Product')->findAll();
     ...
     * @Route("/", name="_create")
     * @Method("POST")
     * @Template("SklepBundle:Product:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SklepBundle:Product')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SklepBundle:Product:edit.html.twig")
     */
